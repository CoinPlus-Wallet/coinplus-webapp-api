...
import { SignUpUserMutation, useSignUpUserMutation } from '../client/generated/graphql';
...
const Home: NextPage = () => {
  ...
  const { mutate: SignUpUser, isLoading } = useSignUpUserMutation<Error>(graphqlRequestClient, {
  ...
  return (
    <section className="py-8 bg-ct-blue-600 min-h-screen grid place-items-center">
      <div className="w-full">
        <h1 className="text-4xl xl:text-6xl text-center font-[600] text-ct-yellow-600 mb-4">Welcome to Coinplus!</h1>

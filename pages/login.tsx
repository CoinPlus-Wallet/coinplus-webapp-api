...
import { LoginUserMutation, useGetMeQuery, useLoginUserMutation } from '../client/generated/graphql';
...
const LoginPage: NextPage = () => {
  ...
  const { isLoading, mutate: loginUser } = useLoginUserMutation<Error>(graphqlRequestClient, {
  ...
  return (
    <section className="bg-ct-blue-600 min-h-screen grid place-items-center">
      <div className="w-full">
        <h1 className="text-4xl xl:text-6xl text-center font-[600] text-ct-yellow-600 mb-4">Welcome Back</h1>
